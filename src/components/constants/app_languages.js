...
const appLanguages =
  {
    ...
    bicycleParkingIncluded: { en: 'Bicycle Parking Included', jp: '自転置場込み' },
    motorcycleParkingIncluded: { en: 'Motorcyle Parking Included', jp: 'バイク置場込み' },
    ...
    requiredFieldsEdit: { en: 'Required fields',
      jp: '必須項目。' },
    // my page
