...
const appLanguages =
  {
    ...
    managementFees: { en: 'Mgmt Fees (amount)', jp: '共益費(円)' },
    ...
    save: { en: 'Save', jp: '保存' },
    ifOwnerDifferent: { en: 'Owner is titleholder of listed property. Fill in below only if owner is different from user', jp: '物件の所有者。ユーザーが物件の所有者では無い場合、以下をご記入ください。' },
    ...
    under1minute: { en: '1 minutes or less', jp: '１分以下' },
    under3minutes: { en: 'Under 3 minutes', jp: '3分以下' },
    under5minutes: { en: 'Under 5 minutes', jp: '5分以下' },
    under7minutes: { en: 'Under 7 minutes', jp: '7分以下' },
    under10minutes: { en: 'Under 10 minutes', jp: '10分以下' },
    under15minutes: { en: 'Under 15 minutes', jp: '15分以下' },
    over15minutes: { en: 'Over 15 minutes', jp: '15分超' },
    orMore4: { en: '4 or More', jp: '4以上' },
    requiredLanguage: { en: 'A language is required.', jp: '言語は必要項目です。' },
    requiredAddress1: { en: 'A street address is required.', jp: '町村番地は必要項目です。' },
    requiredCity: { en: 'A city, district or ward is required.', jp: '市区は必要項目です。' },
    requiredState: { en: 'A state or province is required.', jp: '都道府県は必要項目です。' },
    requiredZip: { en: 'A zip or postal code is required.', jp: '郵便番号は必要項目です。' },
    requiredCountry: { en: 'A country is required.', jp: '国名は必要項目です。' },
    requiredPricePerMonth: { en: 'A price per month is required.', jp: '家賃は必要項目です。' },
    requiredFloorSpace: { en: 'Floor space is required.', jp: '面積は必要項目です。' },
    requiredRooms: { en: 'A number of rooms is required.', jp: '部屋数は必要項目です。' },
    requiredMinutesToStation: { en: 'Minutes to a station is required.', jp: '駅徒歩時間(分)は必要項目です。' },
    oneRoom: { en: 'One room studio', jp: 'ワンルーム' },
    orMore6: { en: '6 or more', jp: '6以上' },
    ownerName: { en: 'Owner Name', jp: '家主' },
    ownerContactName: { en: 'Owner Contact Name', jp: '家主の担当者名' },
    ownerAddress: { en: 'Owner Address', jp: '家主の住所' },
    ownerPhone: { en: 'Owner Phone', jp: '家主の電話番号' },
    ownershipRights: { en: 'Ownership Rights', jp: '所有権' },
    otherRights: { en: 'Other rights', jp: '所有権以外の権利' },
    noCancellation: { en: 'No cancellation', jp: '不可' },
    noSmoking: { en: 'No', jp: '禁煙' },
    editBasicInfo: { en: 'Basic Info & Amenities', jp: '基本情報＆設備' },
    editBuildingInfo: { en: 'Building Info', jp: '基本情報＆設備' },
    editFacilitiesInfo: { en: 'Facilities Info', jp: 'ファシリティー情報' },
    editRentPayments: { en: 'Rent Payments', jp: '家賃の支払い方法' },
    editLanguages: { en: 'Listing Languages', jp: '言語' },
    editCalendars: { en: 'Calendars', jp: 'カレンダー' },
    editImages: { en: 'Images', jp: '画像' },
    editPlaces: { en: 'Convenient Places', jp: '周辺の便利な場所' },
    editDocuments: { en: 'Documents', jp: 'ドキュメント' },
    ...
    showBookingsForMyFlats: { en: 'Bookings for My Flats', jp: 'My物件の予約' },
    showMyProfile: { en: 'My Profile', jp: 'Myプロフィール' },
    showContractors: { en: 'Contractors', jp: 'Myコントラクター' },
    ...
    selectExistingDocument: { en: 'Select from Existing Documents', jp: '既存のドキュメントから選択' },
    selectDocumentCompleted: { en: 'The existing document has been added to your flat.', jp: '既存のドキュメントはこの物件に追加されました。' },
    selectDocumentForFlat: { en: 'Select Document to Add', jp: '既存のドキュメントを選択。' },
    selectDocumentForFieldValues: { en: 'Select Document', jp: '既存のドキュメントを選択。' },
    showByFlat: { en: 'By Flat', jp: '物件で纏める' },
    showByBooking: { en: 'By Booking', jp: 'ブッキングで纏める' },
    ...
    // editRentPaymentsHeading: { en: 'Rent Payments', jp: '家賃の支払い方法' },
    // editLanguagesHeading: { en: 'Languages', jp: '言語' },
    // editCalendarsHeading: { en: 'Calendars', jp: 'カレンダー' },
    // editImagesHeading: { en: 'Images', jp: '画像' },
    // editPlacesHeading: { en: 'Convenient Places', jp: '周辺の便利な場所' },
