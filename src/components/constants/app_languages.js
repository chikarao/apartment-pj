...
const appLanguages =
  {
    ...
    approvalsChecklist: { en: 'Approvals and Checklist', jp: '承認及びチェックリスト' },
    createDocuments: { en: 'Create Documents', jp: 'ドキュメント作成' },
    savedDocuments: { en: 'Saved Documents', jp: '保存済みのドキュメント' },
    approveBookingRequest: { en: 'Approve Booking Request', jp: '申込を承認' },
    rentalProgress: { en: 'Rental Progress', jp: '進捗状況' },
    reservationRequest: { en: 'Reservation Request', jp: '予約のリクエスト' },
    tenantApproved: { en: 'Tenant Approved', jp: '申込の承認' },
    documentsDelivered: { en: 'Documents Delivered', jp: '契約書送付済み' },
