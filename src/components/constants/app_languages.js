...
const appLanguages =
  {
    ...
    minutesToNearest: { en: 'Minutes to Nearest Station', jp: '駅徒歩' },
    ...
    AddDeletePhotos: { en: 'Add or Delete Photos', jp: '写真を追加・削除  ' },
    ...
    paymentDetails: { en: 'Payment Details', jp: 'ペイメント関係' },
    lastFour: { en: 'Last four digits:', jp: '下４桁' },
    expiration: { en: 'Exp:', jp: '有効期限' },
    addNewCard: { en: 'Add New Card', jp: 'カードを追加' },
    connectBank: { en: 'Connect your bank account', jp: '銀行口座をコネクトしよう' },
