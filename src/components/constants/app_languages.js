...
const appLanguages =
  {
    ...
    editLanguages: { en: 'Languages', jp: '言語' },
    ...
    selectDocumentCompleted: { en: 'The existing document has been assigned to your flat.', jp: '既存のドキュメントは物件に適用されました。' },
    selectDocumentForFlat: { en: 'Select Existing Document for Flat', jp: '既存のドキュメントを選択。' },
    byFlat: { en: 'By Flat', jp: '物件で纏める' },
    byBooking: { en: 'By Booking', jp: 'ブッキングで纏める' },
    showAll: { en: 'Show All', jp: '全て並べる' },
    newest: { en: 'Newest', jp: '新しい順' },
    oldest: { en: 'Oldest', jp: '古い順' },
