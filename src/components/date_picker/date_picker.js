...
class DatePicker extends Component {
 ...
 componentDidMount() {
   console.log('in date_picker, componentDidUpdate, this.props.daysToDisable', this.props.daysToDisable);
   const { daysToDisable } = this.props;
   // populate array to check if day is a disabled day. Used for first clicks
   // and second clicks to check day and range
   this.populateDisabledDaysArray(daysToDisable);
 }
 ...
 populateDisabledDaysArray(daysToDisable) {
